...
path = r'D:\Cambio_Climatico_Mendoza/'

path_out = r'D:\Cambio_Climatico_Mendoza\02_Climate_Change_Scenarios\06_Ensamble_Series\Daily\TS_1/'
# Cargar los archivos de datos
file_path_obs = '02_Datos_obs_Mendoza.xlsx'
...
scenarios_data = pd.read_excel(path +r'02_Climate_Change_Scenarios\06_Ensamble_Series\Daily\TS_1/'+file_path_scenarios, sheet_name=None)
